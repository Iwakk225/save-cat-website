...
export default function HowTo() {
    ...
    // Efek untuk melakukan smooth scroll ketika hash URL adalah '#howto'
    useEffect(() => {
        if (location.hash === '#howto') {
            const element = document.getElementById('howto');
            if (element) {
                // Timeout kecil memastikan DOM sudah sepenuhnya di-render sebelum di-scroll
                setTimeout(() => {
    ...
    return (
        // Ditambahkan 'scroll-mt-24' agar saat di-scroll, section tidak tertutup oleh navbar fixed (h-20 = 80px)
        <section id="howto" className="relative py-20 bg-green-700/95 overflow-hidden scroll-mt-24">
            ...
            <svg className="absolute top-12 left-[15%] w-12 h-12 text-emerald-400/20 rotate-23 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66.95-2.3c.48.17.98.3 1.34.3C19 20 22 3 22 3c-1 2-8 2.25-13 3.25S2 11.5 2 13.5s1.75 3.75 1.75 3.75C7 8 17 8 17 8z" />
            </svg>
            <svg className="absolute top-[45%] right-[8%] w-16 h-16 text-green-300/15 rotate-[-67deg] pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66.95-2.3c.48.17.98.3 1.34.3C19 20 22 3 22 3c-1 2-8 2.25-13 3.25S2 11.5 2 13.5s1.75 3.75 1.75 3.75C7 8 17 8 17 8z" />
            </svg>
            <svg className="absolute bottom-24 left-[22%] w-10 h-10 text-teal-300/20 rotate-142 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66.95-2.3c.48.17.98.3 1.34.3C19 20 22 3 22 3c-1 2-8 2.25-13 3.25S2 11.5 2 13.5s1.75 3.75 1.75 3.75C7 8 17 8 17 8z" />
            </svg>
            <svg className="absolute top-[28%] right-[18%] w-14 h-14 text-emerald-300/15 rotate-311 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66.95-2.3c.48.17.98.3 1.34.3C19 20 22 3 22 3c-1 2-8 2.25-13 3.25S2 11.5 2 13.5s1.75 3.75 1.75 3.75C7 8 17 8 17 8z" />
            </svg>
            <svg className="absolute bottom-[35%] left-[5%] w-11 h-11 text-green-400/15 rotate-[-89deg] pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17 8C8 10 5.9 16.17 3.82 21.34l1.89.66.95-2.3c.48.17.98.3 1.34.3C19 20 22 3 22 3c-1 2-8 2.25-13 3.25S2 11.5 2 13.5s1.75 3.75 1.75 3.75C7 8 17 8 17 8z" />
            </svg>

            <svg className="absolute top-20 right-[12%] w-20 h-20 text-green-900/10 pointer-events-none" viewBox="0 0 100 100" fill="currentColor">
            ...
            <svg className="absolute bottom-20 left-[30%] w-24 h-16 text-green-900/10 pointer-events-none" viewBox="0 0 120 60" fill="currentColor">
            ...
            <svg className="absolute top-[18%] left-[42%] w-6 h-6 text-white/10 rotate-17 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg className="absolute bottom-[22%] right-[38%] w-5 h-5 text-white/10 rotate-[-34] pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <ellipse cx="12" cy="16" rx="5" ry="4" />
                <circle cx="7" cy="10" r="2" />
                <circle cx="17" cy="10" r="2" />
                <circle cx="10" cy="7" r="1.5" />
            ...
            <svg className="absolute top-[55%] left-[8%] w-4 h-4 text-white/10 rotate-78 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <ellipse cx="12" cy="16" rx="5" ry="4" />
                <circle cx="7" cy="10" r="2" />
                <circle cx="17" cy="10" r="2" />
                <circle cx="10" cy="7" r="1.5" />
            ...
            <svg className="absolute top-[38%] right-[5%] w-5 h-5 text-white/8 rotate-[-52deg] pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <ellipse cx="12" cy="16" rx="5" ry="4" />
                <circle cx="7" cy="10" r="2" />
                <circle cx="17" cy="10" r="2" />
                <circle cx="10" cy="7" r="1.5" />
            ...
            <svg className="absolute bottom-[12%] left-[55%] w-4 h-4 text-white/10 rotate-123 pointer-events-none" viewBox="0 0 24 24" fill="currentColor">
                <ellipse cx="12" cy="16" rx="5" ry="4" />
                <circle cx="7" cy="10" r="2" />
                <circle cx="17" cy="10" r="2" />
                <circle cx="10" cy="7" r="1.5" />
            ...
            <svg className="absolute left-0 top-[20%] w-24 h-56 text-green-900/10 pointer-events-none" viewBox="0 0 100 200" fill="currentColor">
            ...
            <svg className="absolute right-0 bottom-[15%] w-20 h-48 text-green-900/8 pointer-events-none" viewBox="0 0 100 200" fill="currentColor">
